    ...
    <body>
        <div class="mother_wallpaper">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-sm-1">
                                ...
                                <i class="fa fa-envelope" aria-hidden="true" id="phone-number1">
                                   <h5>joserodrigon@hotmail.com</h5></i>
                                <br><br>
            ...
            if(isset($_POST['add_to_cart_frame'])){
                ...
                $moldura->insert_into_cart('INSERT INTO carts(cart_user_id,cart_full_frame_id,cart_single_frame_id,cart_price,cart_type,cart_name,cart_image) VALUES("'.
                    $_SESSION["user_id"].'","'.$_POST["hide_button_frame_id"].'",0,"'.$_POST["hide_button_frame_price"].'",1,"'.$cart_name.'","'.$cart_image.'")');
            }
            $form_action = "";
        }else{
